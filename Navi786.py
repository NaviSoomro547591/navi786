...
name = raw_input ("\033[91mAp ka Nama ?(Navi786Nama Real) : ")                 

                 

if name == (""):                 

     print '\x1b[1;92mReal Nama istmal karain navi786 :V'                 
...
if password == ("Naveed786"):                 
     ...
     print 'Welcome ' + name + 'navi786'                 

     time.sleep(0.8)                 

     print 'Semoga beruntung ' + name + ' navi786'                 
